 ...
 */
package com.erastedev.ciexplore.v1.adapters.web.http.rights;
...
import com.erastedev.ciexplore.v1.adapters.web.message.rights.RightCustomMessage;
...
public class RightController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<com.erastedev.ciexplore.v1.adapters.web.api.ApiResponse<Right>> update(
