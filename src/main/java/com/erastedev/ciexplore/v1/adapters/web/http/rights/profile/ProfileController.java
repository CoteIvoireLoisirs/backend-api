 ...
 */
package com.erastedev.ciexplore.v1.adapters.web.http.rights.profile;
...
public class ProfileController {
   ...
   /* @Operation(summary = "Get All Entities", description = "Fetches all entities, optionally filtered by query parameters.")
    ...
    @GetMapping("{id}")
    public ResponseEntity<com.erastedev.ciexplore.v1.adapters.web.api.ApiResponse<ModuleProfileRight>> getSingle(
            @PathVariable int id
    ) {
        try {
    ...
    @GetMapping
    public ResponseEntity<com.erastedev.ciexplore.v1.adapters.web.api.ApiResponse<List<ModuleProfileRight>>> getAll() {
        try {
    ...
    @PostMapping
    public ResponseEntity<com.erastedev.ciexplore.v1.adapters.web.api.ApiResponse<ModuleProfileRight>> create(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<com.erastedev.ciexplore.v1.adapters.web.api.ApiResponse<ModuleProfileRight>> update(
