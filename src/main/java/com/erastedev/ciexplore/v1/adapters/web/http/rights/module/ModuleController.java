 ...
 */
package com.erastedev.ciexplore.v1.adapters.web.http.rights.module;
...
public class ModuleController {
    ...
    @GetMapping
    public ResponseEntity<com.erastedev.ciexplore.v1.adapters.web.api.ApiResponse<List<Module>>> getAll() {
        try {
