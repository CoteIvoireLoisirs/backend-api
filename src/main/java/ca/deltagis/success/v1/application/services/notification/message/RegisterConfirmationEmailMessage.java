package ca.deltagis.success.v1.application.services.notification.message;

public class RegisterConfirmationEmailMessage {

    public static final String SUBJECT = "[SUCCESS] REGISTRATION SUCCESSFUL";
     ...
     */
    public static String MESSAGE(String fullName, String userName) {
