 ...
 */
package ca.deltagis.success.v1.adapters.web.http.workspace;
...
import ca.deltagis.success.v1.application.request.workspace.WorkspaceSaveResponse;
...
import ca.deltagis.success.v1.domain.core.models.workspace.WorkspacePublic;
...
public class WorkspaceController extends AbstractCommonController<Workspace> {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ca.deltagis.success.v1.adapters.web.api.ApiResponse<Workspace>> getById(
    ...
    @PostMapping
    public ResponseEntity<ca.deltagis.success.v1.adapters.web.api.ApiResponse<Workspace>> create(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ca.deltagis.success.v1.adapters.web.api.ApiResponse<Workspace>> update(
    ...
    public ResponseEntity<ca.deltagis.success.v1.adapters.web.api.ApiResponse<Workspace>> activate(
    ...
    public ResponseEntity<ca.deltagis.success.v1.adapters.web.api.ApiResponse<Workspace>> disable(
    ...
    public ResponseEntity<ca.deltagis.success.v1.adapters.web.api.ApiResponse<List<WorkspacePublic>>> getAllWithOutAuthorization() {
        try {
