package ca.deltagis.success.v1.domain.core.entities.rights;
...
@Setter
@Table(name = "rights")
public class Right extends AbstractCommonEntity<Right> {
    @Id
     ...
     */
    @Override
    public int compareTo(Right object) {
