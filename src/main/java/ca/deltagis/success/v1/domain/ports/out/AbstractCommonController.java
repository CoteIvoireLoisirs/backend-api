...
import ca.deltagis.success.v1.domain.ports.in.ICommonController;
...
public abstract class AbstractCommonController<T extends ICommonEntity<T>> implements ICommonController<T> {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ca.deltagis.success.v1.adapters.web.api.ApiResponse<T>> getById(
    ...
    @GetMapping
    public ResponseEntity<ca.deltagis.success.v1.adapters.web.api.ApiResponse<List<T>>> getAlls(
    ...
    @PostMapping
    public ResponseEntity<ca.deltagis.success.v1.adapters.web.api.ApiResponse<T>> create(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ca.deltagis.success.v1.adapters.web.api.ApiResponse<T>> update(
